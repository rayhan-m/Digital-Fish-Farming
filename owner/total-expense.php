      ...
      <table border="1" cellspacing="0" cellpadding="3" align="center" >  
           <thead>
		      <tr>
		        ...
		        <th width="60%">Title of Expense</th>
	    	...
	    	<tr class="success">
		        <td width="10%">1</td>
		        <td width="60%">Buy Fish</td>
		        <td width="30%">'. $TotalBuyFish.' TK</td>
		      </tr>
		      <tr class="success">
		        <td width="10%">2</td>
		        <td width="60%">Buy Food</td>
		        <td width="30%">'.$TotalBuyFood.' TK</td>
		      </tr>
		      <tr>
		        <td width="10%">3</td>
		        <td width="60%">Staff Salary</td>
		        <td width="30%">'.$TotalStaffSalary.' TK</td>
		      </tr>
		      <tr>
		        <td width="10%">4</td>
		        <td width="60%">Manager Salary</td>
		        <td width="30%">'.$TotalManagerSalary.' TK</td>
		      </tr>
		       <tr>
		        <td width="10%"></td>
										...
										<div class="col-md-4">
										  ...
										  <table class="table table-bordered table-hover">
									    	...
									    	<tr class="success">
										        <td>1</td>
										        <td>Buy Fish</td>
										        <td><?php echo $TotalBuyFish;?> TK</td>
										      </tr>
										      <tr class="success">
										        <td>2</td>
										        <td>Buy Food</td>
										        <td><?php echo $TotalBuyFood;?> TK</td>
										      </tr>
										      <tr>
										        <td>3</td>
										        <td>Staff Salary</td>
										        <td><?php echo $TotalStaffSalary;?> TK</td>
										      </tr>
										      <tr>
										        <td>4</td>
										        <td>Manager Salary</td>
										        <td><?php echo $TotalManagerSalary;?> TK</td>
										      </tr>
										       <tr>
										        <td></td>
										        <td>Total Expense = </td>
