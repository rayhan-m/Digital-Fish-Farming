...
if (isset($_GET['delete'])) {
	$fish_id = $_GET['delete'];
	$message = $DBM->deleteFish($fish_id);
}
if (isset($_GET['edit'])) {
	$fish_id = $_GET['edit'];
	$fish_id = $_GET['fish_id'];
	$editFish = $DBM->editPond($fish_id);
	$Fish = mysqli_fetch_assoc($editFish);
}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<table id="MyDataTable" class="table table-striped table-bordered" style="width:100%">
												...
												<tbody>
													<?php
													while ($viewFish = mysqli_fetch_assoc($query)) {
														?>
														<tr>
															<td><?php echo @$viewFish['fish_id']; ?></td>
															<td><?php echo @$viewFish['fish_name']; ?></td>
															<td class="text-center"><?php echo "<img src='". @$viewFish['img'] . "'height='70' width='120'>"; ?>
														</td>
														<td>
															<a href="editFish.php?fish_id=<?php echo $viewFish['fish_id']; ?>" class="btn btn-success"   title="Edit" ><i class="fas fa-edit"></i></a> 
															<a href="?delete=<?php echo $viewFish['fish_id']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are You Sure To Delete!');" ><i class="fas fa-trash-alt"></i></a>
														</td>
													</tr>
												<?php } ?>
											</tbody>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h2 class="modal-title " id="exampleModalLabel">Fish Information</h2>
								...
								<div class="modal-body">
									<form action="" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<input type="text" name="fish_name" class="form-control" placeholder="Enter Fish Name" required>
										</div>                           
										<div class="form-group">
