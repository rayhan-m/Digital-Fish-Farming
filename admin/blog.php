...
if (isset($_GET['delete'])) {
	$blog_id = $_GET['delete'];
	$message = $DBM->deletePost($blog_id);
}
if (isset($_GET['edit'])) {
	$post_id = $_GET['edit'];
	$post_id = $_GET['post_id'];
	$editPost = $DBM->editPost($post_id);
	$Post = mysqli_fetch_assoc($editFish);
}
?>
									...
									<?php
										...
										<div class="col-md-4">
											<article class="article-entry">
												...
												<img style="width:100%; height: 210px;" src="<?=$viewPost['img']?>" >
												<div class="desc">
												...
												<a href="?delete=<?php echo $viewPost['blog_id']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are You Sure To Delete!');" ><i class="fas fa-trash-alt"></i></a>
											</article>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h2 class="modal-title " id="exampleModalLabel">Blog Post Information</h2>
