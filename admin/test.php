							...
							<li class=" has-sub">
								...
								<li class=" has-sub">
									<a class="js-arrow" href="#">
										...
										<ul class="list-unstyled navbar__sub-list js-sub-list">
											<li>
												<a href="bid-info.php">Total Earning</a>
											</li>
											<li>
												<a href="bid-board.php">Total Expense</a>
											</li>
											<li>
												<a href="bidding.php">Income Summery</a>
											</li>
										</ul>
									</li>
									<li>
										<a href="#"><i class="fas fa-cart-arrow-down"></i>Sell Information</a>
									</li>
								</ul>
					</nav>
				</div>
						...
						<div class="row">
							<div class="col-md-10 col-md-offset-1">
									...
									<div class="form-group row">
										...
										<div class="col-8">
											<input class="form-control here " disabled value="<?php echo $tt['bid_id'];?>">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-form-label">Full Name</label> 
										<div class="col-8">
											<input class="form-control here " disabled value="<?php echo $tt['full_name'];?>">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-form-label">User Name</label> 
										<div class="col-8">
											<input class="form-control here " disabled value="<?php echo $tt['user_name'];?>">
										</div>
									</div>
									<div class="form-group row">
