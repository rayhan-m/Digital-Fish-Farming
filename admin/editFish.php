...
$DBM = new DBManager();
$editFish = $DBM->editFish($fish_id);
$Fish = mysqli_fetch_assoc($editFish);
if (isset($_POST['button'])) {
    $DBM->updateFish($_POST);
}
?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <div class="panel-heading ">
                                                <h1 class="text-center"> Edit Fish Info</h1>
                                            </div> <!-- /panel-heading -->   
                                            <div class="test">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <input type="hidden" name="fish_id" value="<?php echo $Fish['fish_id']; ?>" class="form-control" >
                                                        
                                                        <div class="form-group">
                                                            <label>Fish Name:</label>
                                                            <input type="text" name="fish_name" class="form-control" placeholder="Enter Fish Name" value="<?php echo $Fish['fish_name']; ?>" required>
                                                        </div>                           
                                                        <div class="form-group">
                                                            <label>Upload Image</label>
                                                            <input type="file" name="fileToUpload" id="fileToUpload" value="<?php echo $Fish['img'];?>" required>
                                                            <td class="text-center"><?php echo "<img src='". @$Fish['img'] . "'height='70' width='120'>"; ?>
                                                        </td>
                                                    </div>
                                                    <button type="submit" name="button" class="btn btn-primary ">Update</button>
                                                    <a href="fish.php" class="btn btn-secondary pull-right">Cancel</a>
                                                </form>
